...
const infoContentColumn2 = `
	<h2>Recently</h2>
	<p>
		Joined Publicis Toronto as a Senior Designer, working across branding, campaign ideation/implementation for a range of brands and creative teams.
	</p>

	<h2>Currently</h2>
	<p>
		Redesigning a Toronto-based treatment agency, while continuing to develop independent concepts and exploratory work.
	</p>
...
const infoContentColumn3 = `
	<h2>About</h2>
	<p>
		I help teams turn complex, ambiguous ideas into clear stories and visuals that people actually understand and buy into. My work lives in the space between strategy and execution, where ideas need to hold up creatively, structurally, and under pressure.</p>I’ve worked across agencies, production companies, and independent teams, building everything from keynote presentations and treatment systems to brand identities and narrative frameworks. Whether it’s shaping a pitch for a global campaign or creating systems that help creative scale, the focus is always the same: making ideas clearer, stronger, and easier to move forward.
	</p>
`;
